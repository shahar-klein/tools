...
BASE_RX_BYTES=`ethtool -S $RP_PRIV_LEG_DEV | grep "rx_bytes_phys:" | awk '{print  $2}'`
BASE_TX_BYTES=`ethtool -S $RP_PUB_LEG_DEV | grep "tx_bytes_phys:" | awk '{print  $2}'`
...
do
        ...
        # RX bytes
        rx_bytes=`ethtool -S $RP_PRIV_LEG_DEV | grep "rx_bytes_phys:" | awk '{print  $2}'`
        echo $dur $((rx_bytes-BASE_RX_BYTES)) >> $RESULTS_LOG_DIR/${RP_PRIV_LEG_DEV}.tput

        # TX bytes
        tx_bytes=`ethtool -S $RP_PUB_LEG_DEV | grep "tx_bytes_phys:" | awk '{print  $2}'`
