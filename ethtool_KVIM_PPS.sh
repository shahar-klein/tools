...
while [ 1 ] ; do
RX1D1=`read_ethx_val $DEV1 rx-0.bytes`
TX1D1=`read_ethx_val $DEV1 tx-0.bytes`
PRX1D1=`read_ethx_val $DEV1 rx-0.packets`
PTX1D1=`read_ethx_val $DEV1 tx-0.packets`
if [ $DEV2 ] ; then
...
sleep $DT
RX2D1=`read_ethx_val $DEV1 rx-0.bytes`
TX2D1=`read_ethx_val $DEV1 tx-0.bytes`
PRX2D1=`read_ethx_val $DEV1 rx-0.packets`
PTX2D1=`read_ethx_val $DEV1 tx-0.packets`
if [ $DEV2 ] ; then
